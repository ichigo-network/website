<template>
  <component
    :is="tag"
    :class="[
      `!text-gray-900 bg-primary-300 inline-block shadow-lg focus:ring-1 focus:ring-primary-500 focus:outline-none rounded-sm hover:bg-primary-400 font-normal
